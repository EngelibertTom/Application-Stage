 ...
 */
final class Version20220425104055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pret_equipement (id INT AUTO_INCREMENT NOT NULL, equipement_id INT NOT NULL, date DATE NOT NULL, utilisateur LONGTEXT NOT NULL, INDEX IDX_5E66FA02806F0F5C (equipement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE pret_equipement ADD CONSTRAINT FK_5E66FA02806F0F5C FOREIGN KEY (equipement_id) REFERENCES equipement (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE pret_equipement');
