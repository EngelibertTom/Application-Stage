...
class TreeWorkType extends AbstractType
{
            ...
            $builder
                ->add('user', EntityType::class, [
                    ...
                    'query_builder' => function (EntityRepository $er) {
                        ...
                        {
                            $qb->leftJoin('u.managementNurseries', 'managementNurseries')
                                ->where('managementNurseries.nursery = :nursery')
